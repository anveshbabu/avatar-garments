...
export class UserList extends React.Component {
    ...
    handleMoreOptions = (type) => {
        ...
        alertModel.okBtn = 'yes, De-Active'
        alertModel.title = 'Are you sure you want to De-Active this account';
    ...
    render() {
        let { userList, isUserEditModal, alertModel } = this.state;
        let optionsList = [
            ...
            <div className="row">
                <div className="col">
                    <table class="table table-borderless user-list table-striped">
                        ...
                        <tbody>
                            {userList.map(({ name, email, phone }, i) =>
                                <tr>
                                    <th scope="row">{i + 1}</th>
                                    <td>{name}</td>
                                    <td>{email}</td>
                                    ...
                                    <td>Manager</td>
                                    <td>Admin</td>
                                    <td className="active status-text">Active</td>
                                    <td>
                                    <NormalDropdown
                                    ...
                                    {/* <td><i className="btn bi bi-pencil text-success border-right" title="Edit" onClick={() => this.setState({ isUserEditModal: true })}></i> <i className="btn bi bi-trash text-danger" title="de-active" onClick={this.handleUserDeactive}></i></td> */}
                                </tr>
                            )}
                        </tbody>
                    </table>
                ...
                <UserEdit isShow={isUserEditModal} toggle={() => this.setState({ isUserEditModal: false })} />
